...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card ">
            <div class="card-body">
                <form class="form-horizontal" action="{{ $model->exists ? route('items.update', base64_encode($model->id)) : route('items.store') }}" method="POST">
                    {{ csrf_field() }}
                    @if ($model->exists)
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="qty" class="col-sm-12 col-form-label">Quantity <span class="text-red">*</span></label>
                            <div class="col-sm-12">
                                <input type="text" name="qty" id="qty" class="form-control form-control-sm number" placeholder="Quantity" value="{{ $model->exists ? format_rupiah($model->qty) : old('qty') }}">
                                @error('qty')
                                <small class="text-red">
                                    <strong>{{ $message }}</strong>
                                </small>
                        ...
                        <div class="form-group col-md-6">
                            <label for="uom" class="col-sm-12 col-form-label">Uom <span class="text-red">*</span></label>
                            <div class="col-sm-11">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-append">
                                        <button type="button" class="btn  bg-inventory btn-sm btn-flat ml-1" data-toggle="modal" data-target="#modal-uom"><i class="fas fa-plus"></i> Add Uom</button>
                                    </span>
                                </div>
                                @error('uom')
                                <small class="text-red">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="category_id" class="col-sm-12 col-form-label">Category <span class="text-red">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group col-md-6">
                            <label for="warehouse_id" class="col-sm-12 col-form-label">Warehouse <span class="text-red">*</span></label>
                            <div class="col-sm-12">
                                <select class="select2 form-control" name="warehouse_id" id="warehouse_id">
                                    @if ($model->exists)
                                    <option value="{{ $model->warehouse_id }}">{{ $model->warehouse->name }}</option>
                                    @else
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="sale_price" id="sale_price" class="form-control form-control-sm number" placeholder="Sell Price" value="{{ $model->exists ? format_rupiah($model->sale_price) : old('sale_price') }}">
                                @error('sale_price')
                                <small class="text-red">
                                    <strong>{{ $message }}</strong>
                                </small>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="discount" id="discount" class="form-control form-control-sm number" placeholder="Discount" value="{{ $model->exists ? $model->discount : old('discount') }}">
                                @error('discount')
                                <small class="text-red">
                                    <strong>{{ $message }}</strong>
                                </small>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-12">
                                <input type="date" name="expired_date" id="expired_date" class="form-control form-control-sm" placeholder="Expired Date" value="{{ $model->exists ? $model->expired_date : old('expired_date') }}">
                                @error('expired_date')
                                <small class="text-red">
                                    <strong>{{ $message }}</strong>
                                </small>
                ...
                <form class="form-horizontal" action="{{ route('master.uom.store') }}" method="POST">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="name" class="col-sm-12 col-form-label">Name <span class="text-red">*</span></label>
                            <div class="col-sm-12">
                                <input type="text" name="name" id="nameUom" class="form-control" placeholder="Nama" @if ($model->exists) value="{{ $model->uom->name }}" @endif>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="code" id="codeUom" class="form-control" placeholder="pcs " @if ($model->exists) value="{{ $model->uom->code }}" @endif>
