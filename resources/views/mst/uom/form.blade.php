    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">
                    @if ($model->exists)
                    <i class="nav-icon fas fa-eidt"></i> Edit Unit Of Material
                    @else
                    <i class="nav-icon fas fa-plus"></i> Add Unit Of Material
                    @endif
                </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><i class="nav-icon fas fa-boxes"></i> Unit Of Material</li>
                    @if ($model->exists)
                    <li class="breadcrumb-item active"><i class="nav-icon fas fa-edit"></i> Edit Unit Of Material</li>
                    @else
                    <li class="breadcrumb-item active"><i class="nav-icon fas fa-plus"></i> Add Unit Of Material</li>
                    @endif
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card ">
            <div class="card-body">
                <form class="form-horizontal" action="{{ $model->exists ? route('master.uom.update', base64_encode($model->id)) : route('master.uom.store') }}" method="POST">
                    {{ csrf_field() }}
                    @if ($model->exists)
